...
public class homework2 {
    ...
    public static void main(String[] args) {
       ...
       /* Вызов метода возвращает True, если сумма левой и правой части массива равны. Иначе False
            {1, 1, 0, || 5, 2} - false
            {1, 1, 1, || 2, 1} - true
            {10, 0, || 5, 2, 7} - false
            {1, 2, || 0, 3} - true
    ...
    */
    ...
    /*
        Вызов метода генерирует случайный массив с определенными параметрами.
         ...
         Например, generateArray(7, 10) - Сгенерируется массив с размером 7 и диапазоном чисел от 0 до 10.
     */
